...
- [x] Have user accounts. A user should have at least the following attributes:
  - [x] Username: filmnest
  - [x] Email address: siciliap1989@gmail.com
  - [x] Password: password
- [x] Ability to create a “project” to be crowdfunded which will include at least the following attributes:
  - [x] Title: filmnest
  - [x] Owner (a user): Sicilia
  - [x] Description: Supporting the next generation of film frames in Perth.
  - [x] Image: Something filmy
  - [ ] Target amount to fundraise: $10,000
  - [x] Whether it is currently open to accepting new supporters or not: Yes
  - [x] When the project was created: Start of Django project 
- [ ] Ability to “pledge” to a project. A pledge should include at least the following attributes:
  - [x] An amount: 
  - [x] The project the pledge is for: filmnest
  - [x] The supporter/user (i.e. who created the pledge): Sicilia
  - [x] Whether the pledge is anonymous or not: Yes, it will be anonymous
